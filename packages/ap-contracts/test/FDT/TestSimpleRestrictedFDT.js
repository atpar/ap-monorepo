...
contract('SimpleRestrictedFDT', function (accounts) {
  ...
  beforeEach(async function () {
    ...
    await this.fundsDistributionToken.addToWhitelist(tokenHolder1, '1');
    await this.fundsDistributionToken.addToWhitelist(tokenHolder2, '1');
    await this.fundsDistributionToken.addToWhitelist(tokenHolder3, '1');
    await this.fundsDistributionToken.addToWhitelist(anyone, '1');
  });
