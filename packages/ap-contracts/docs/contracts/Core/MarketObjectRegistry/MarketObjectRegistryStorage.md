...
[MarketObjectRegistryStorage]: #MarketObjectRegistryStorage
[MarketObjectRegistryStorage-dataPoints-mapping-bytes32----mapping-uint256----struct-MarketObjectRegistryStorage-DataPoint--]: #MarketObjectRegistryStorage-dataPoints-mapping-bytes32----mapping-uint256----struct-MarketObjectRegistryStorage-DataPoint--
[MarketObjectRegistryStorage-marketObjectLastUpdatedAt-mapping-bytes32----uint256-]: #MarketObjectRegistryStorage-marketObjectLastUpdatedAt-mapping-bytes32----uint256-
[MarketObjectRegistryStorage-marketObjectProviders-mapping-bytes32----address-]: #MarketObjectRegistryStorage-marketObjectProviders-mapping-bytes32----address-
...
## <span id="MarketObjectRegistryStorage"></span> `MarketObjectRegistryStorage`

Describes the storage of the MarketObjectRegistry
