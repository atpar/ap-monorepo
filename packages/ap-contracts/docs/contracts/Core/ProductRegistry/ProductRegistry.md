...
[ProductRegistry-getProductTerms-bytes32-]: #ProductRegistry-getProductTerms-bytes32-
[ProductRegistry-getEventAtIndex-bytes32-uint8-uint256-]: #ProductRegistry-getEventAtIndex-bytes32-uint8-uint256-
[ProductRegistry-getScheduleLength-bytes32-uint8-]: #ProductRegistry-getScheduleLength-bytes32-uint8-
[ProductRegistry-getSchedule-bytes32-uint8-]: #ProductRegistry-getSchedule-bytes32-uint8-
[ProductRegistry-registerProduct-struct-SharedTypes-ProductTerms-struct-SharedTypes-ProductSchedules-]: #ProductRegistry-registerProduct-struct-SharedTypes-ProductTerms-struct-SharedTypes-ProductSchedules-
[ProductRegistry-RegisteredProduct-bytes32-]: #ProductRegistry-RegisteredProduct-bytes32-
...
## <span id="ProductRegistry"></span> `ProductRegistry`

Registry for ACTUS compatible products.
A Product is made up of a set of ProductTerms and ProductSchedules.



- [`getProductTerms(bytes32 productId)`][ProductRegistry-getProductTerms-bytes32-]
- [`getEventAtIndex(bytes32 productId, uint8 scheduleId, uint256 index)`][ProductRegistry-getEventAtIndex-bytes32-uint8-uint256-]
- [`getScheduleLength(bytes32 productId, uint8 scheduleId)`][ProductRegistry-getScheduleLength-bytes32-uint8-]
- [`getSchedule(bytes32 productId, uint8 scheduleId)`][ProductRegistry-getSchedule-bytes32-uint8-]
- [`registerProduct(struct SharedTypes.ProductTerms terms, struct SharedTypes.ProductSchedules productSchedules)`][ProductRegistry-registerProduct-struct-SharedTypes-ProductTerms-struct-SharedTypes-ProductSchedules-]
...
- [`RegisteredProduct(bytes32 productId)`][ProductRegistry-RegisteredProduct-bytes32-]

### <span id="ProductRegistry-getProductTerms-bytes32-"></span> `getProductTerms(bytes32 productId) → struct SharedTypes.ProductTerms` (external)
...
### <span id="ProductRegistry-getEventAtIndex-bytes32-uint8-uint256-"></span> `getEventAtIndex(bytes32 productId, uint8 scheduleId, uint256 index) → bytes32` (external)

Returns an event for a given position (index) in a schedule of a given product.




### <span id="ProductRegistry-getScheduleLength-bytes32-uint8-"></span> `getScheduleLength(bytes32 productId, uint8 scheduleId) → uint256` (external)

Returns the length of a schedule (given its scheduleId) of a given product.




### <span id="ProductRegistry-getSchedule-bytes32-uint8-"></span> `getSchedule(bytes32 productId, uint8 scheduleId) → bytes32[] schedule` (external)

Convenience method for retrieving the entire schedule for a given scheduleId
Not recommended to execute it on-chain (if schedule is too long the tx may run out of gas)




### <span id="ProductRegistry-registerProduct-struct-SharedTypes-ProductTerms-struct-SharedTypes-ProductSchedules-"></span> `registerProduct(struct SharedTypes.ProductTerms terms, struct SharedTypes.ProductSchedules productSchedules)` (public)

Stores a new product for given set of ProductTerms and ProductSchedules.
...
### <span id="ProductRegistry-RegisteredProduct-bytes32-"></span> `RegisteredProduct(bytes32 productId)`
