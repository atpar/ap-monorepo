[AssetActor]: ../Core/AssetActor.md#AssetActor
...
[AssetIssuer-custodian-contract-ICustodian]: #AssetIssuer-custodian-contract-ICustodian
[AssetIssuer-productRegistry-contract-IProductRegistry]: #AssetIssuer-productRegistry-contract-IProductRegistry
[AssetIssuer-assetRegistry-contract-IAssetRegistry]: #AssetIssuer-assetRegistry-contract-IAssetRegistry
[AssetIssuer-constructor-contract-ICustodian-contract-IProductRegistry-contract-IAssetRegistry-]: #AssetIssuer-constructor-contract-ICustodian-contract-IProductRegistry-contract-IAssetRegistry-
[AssetIssuer-issueFromOrder-struct-VerifyOrder-Order-]: #AssetIssuer-issueFromOrder-struct-VerifyOrder-Order-
[AssetIssuer-finalizeOrder-struct-VerifyOrder-Order-]: #AssetIssuer-finalizeOrder-struct-VerifyOrder-Order-
[AssetIssuer-finalizeEnhancementOrder-struct-VerifyOrder-EnhancementOrder-struct-VerifyOrder-Order-]: #AssetIssuer-finalizeEnhancementOrder-struct-VerifyOrder-EnhancementOrder-struct-VerifyOrder-Order-
[AssetIssuer-issueAsset-bytes32-struct-SharedTypes-AssetOwnership-bytes32-struct-SharedTypes-CustomTerms-address-address-]: #AssetIssuer-issueAsset-bytes32-struct-SharedTypes-AssetOwnership-bytes32-struct-SharedTypes-CustomTerms-address-address-
[AssetIssuer-ExecutedOrder-bytes32-bytes32-]: #AssetIssuer-ExecutedOrder-bytes32-bytes32-
[AssetIssuer-IssuedAsset-bytes32-address-address-]: #AssetIssuer-IssuedAsset-bytes32-address-address-
...
## <span id="AssetIssuer"></span> `AssetIssuer`

Contract for issuing ACTUS assets. Currently supports the issuance of
independent assets as well as assets with up to two enhancements (such as Guarantee and Collateral).



- [`constructor(contract ICustodian _custodian, contract IProductRegistry _productRegistry, contract IAssetRegistry _assetRegistry)`][AssetIssuer-constructor-contract-ICustodian-contract-IProductRegistry-contract-IAssetRegistry-]
- [`issueFromOrder(struct VerifyOrder.Order order)`][AssetIssuer-issueFromOrder-struct-VerifyOrder-Order-]
- [`finalizeOrder(struct VerifyOrder.Order order)`][AssetIssuer-finalizeOrder-struct-VerifyOrder-Order-]
- [`finalizeEnhancementOrder(struct VerifyOrder.EnhancementOrder enhancementOrder, struct VerifyOrder.Order order)`][AssetIssuer-finalizeEnhancementOrder-struct-VerifyOrder-EnhancementOrder-struct-VerifyOrder-Order-]
- [`issueAsset(bytes32 assetId, struct SharedTypes.AssetOwnership ownership, bytes32 productId, struct SharedTypes.CustomTerms customTerms, address engine, address actor)`][AssetIssuer-issueAsset-bytes32-struct-SharedTypes-AssetOwnership-bytes32-struct-SharedTypes-CustomTerms-address-address-]
...
- [`ExecutedOrder(bytes32 orderId, bytes32 assetId)`][AssetIssuer-ExecutedOrder-bytes32-bytes32-]
- [`IssuedAsset(bytes32 assetId, address creator, address counterparty)`][AssetIssuer-IssuedAsset-bytes32-address-address-]

### <span id="AssetIssuer-constructor-contract-ICustodian-contract-IProductRegistry-contract-IAssetRegistry-"></span> `constructor(contract ICustodian _custodian, contract IProductRegistry _productRegistry, contract IAssetRegistry _assetRegistry)` (public)





### <span id="AssetIssuer-issueFromOrder-struct-VerifyOrder-Order-"></span> `issueFromOrder(struct VerifyOrder.Order order)` (public)

Issues an asset from an order which was signed by the creator obligor and the counterparty obligor.


verifies both signatures and initializes by calling the specified asset actor,
...
### <span id="AssetIssuer-finalizeOrder-struct-VerifyOrder-Order-"></span> `finalizeOrder(struct VerifyOrder.Order order) → bytes32, struct SharedTypes.AssetOwnership, bytes32, struct SharedTypes.CustomTerms, address, address` (internal)

Executes all pre-issuance conditions (e.g. collateral requirements)
defined in the contract references of the order and sets the final ownership of the asset



### <span id="AssetIssuer-finalizeEnhancementOrder-struct-VerifyOrder-EnhancementOrder-struct-VerifyOrder-Order-"></span> `finalizeEnhancementOrder(struct VerifyOrder.EnhancementOrder enhancementOrder, struct VerifyOrder.Order order) → bytes32, struct SharedTypes.AssetOwnership, bytes32, struct SharedTypes.CustomTerms, address, address` (internal)
...
### <span id="AssetIssuer-issueAsset-bytes32-struct-SharedTypes-AssetOwnership-bytes32-struct-SharedTypes-CustomTerms-address-address-"></span> `issueAsset(bytes32 assetId, struct SharedTypes.AssetOwnership ownership, bytes32 productId, struct SharedTypes.CustomTerms customTerms, address engine, address actor)` (internal)





### <span id="AssetIssuer-ExecutedOrder-bytes32-bytes32-"></span> `ExecutedOrder(bytes32 orderId, bytes32 assetId)`





### <span id="AssetIssuer-IssuedAsset-bytes32-address-address-"></span> `IssuedAsset(bytes32 assetId, address creator, address counterparty)`
