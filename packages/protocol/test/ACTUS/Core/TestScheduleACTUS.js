...
describe('Core', () => {
  ...
  //   assert.deepEqual(removeNullDates(await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, c, addEndTime, sStart, sEnd)), result_1);
  // });
  ...
  it('should test computeDatesFromCycleSegment Weekly_SD_shortstub', async () => {
    ...
    const result_1 = removeNullDates(
      await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '7', p: '0', s: '1', isSet: true}, eomc, addEndTime, sStart, sEnd).call()
    );
  ...
  it('should test computeDatesFromCycleSegment 4Weekly_SD_longstub_startEndMonth', async () => {
    ...
    const result_1 = removeNullDates(
      await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '28', p: '0', s: '0', isSet: true}, eomc, addEndTime, sStart, sEnd).call()
    );
  ...
  //   const result_1 = removeNullDates(
  //     await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '28', p: '0', s: '0', isSet: true}, addEndTime, sStart, sEnd)
  //   );
  ...
  it('should test computeDatesFromCycleSegment 4Weekly_EOM_shortstub_startEndMonth', async () => {
    ...
    const result_1 = removeNullDates(
      await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '28', p: '0', s: '1', isSet: true}, eomc, addEndTime, sStart, sEnd).call()
    );
  ...
  *
  ...
  it('should test computeDatesFromCycleSegment Quarterly_SD_shortstub', async () => {
    ...
    const result_1 = removeNullDates(
      await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '3', p: '2', s: '1', isSet: true}, eomc, addEndTime, sStart, sEnd).call()
    );
  ...
  it('should test computeDatesFromCycleSegment Quarterly_SD_longstub', async () => {
    ...
    const result_1 = removeNullDates(
      await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '3', p: '2', s: '0', isSet: true}, eomc, addEndTime, sStart, sEnd).call()
    );
  ...
  //   const result_1 = removeNullDates(
  //     await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '3', p: '2', s: '0', isSet: true}, addEndTime, sStart, sEnd)
  //   );
  ...
  it('should test computeDatesFromCycleSegment BiQuarterly_EOM_longstub', async () => {
    ...
    const result_1 = removeNullDates(
      await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '6', p: '2', s: '0', isSet: true}, eomc, addEndTime, sStart, sEnd).call()
    );
  ...
  it('should test computeDatesFromCycleSegment Halfyear_EOM_longstub', async () => {
    ...
    const result_1 = removeNullDates(
      await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '2', p: '3', s: '0', isSet: true}, eomc, addEndTime, sStart, sEnd).call()
    );
  ...
  it('should test computeDatesFromCycleSegment Yearly_EOM_longstub', async () => {
    ...
    const result_1 = removeNullDates(
      await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '2', p: '4', s: '0', isSet: true}, eomc, addEndTime, sStart, sEnd).call()
    );
  ...
  it('should test computeDatesFromCycleSegment BiYearly_EOM_longstub', async () => {
    ...
    const result_1 = removeNullDates(
      await this.TestCore.methods._computeDatesFromCycleSegment(cStart, cEnd, { i: '4', p: '4', s: '0', isSet: true}, eomc, addEndTime, sStart, sEnd).call()
    );
