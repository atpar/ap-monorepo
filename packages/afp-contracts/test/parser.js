...
const ContractEventDefinitions = require('./AFPDefinitions/ContractEventDefinitions.json')
const ContractTermsDefinitions = require('./AFPDefinitions/ContractTermsDefinitions.json')
